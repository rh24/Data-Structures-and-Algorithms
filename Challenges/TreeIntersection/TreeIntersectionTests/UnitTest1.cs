...
namespace TreeIntersectionTests
{
    public class UnitTest1
    {
        ...
        */
        /// </summary>
        [Fact]
        public void TestDifferentValuesInTree()
        {
        ...
        /// <summary>
        /* BT1 and BT2 have identical node values. Therefore, every single one of its values should be printed to the console except for 3 and 7.
        ...
        */
        /// </summary>
        [Fact]
        public void TestSameValuesInTree()
        {
            Node node3 = new Node(3);
            Node node4 = new Node(4);
            BinaryTree bt1 = new BinaryTree(node4);
            ...
            List<object> overlapping = TreeIntersections(bt1, bt2);
            List<object> expectedValues = new List<object>() { 4, 2, 1, 3, 5 };
            Assert.Equal(overlapping, expectedValues);
        }

        /// <summary>
        /* BT1 and BT2 have a differing number of values.
        ...
        */
        /// </summary>
        [Fact]
        public void TestDifferentSizeTrees()
        {
            Node node4 = new Node(4);
            BinaryTree bt1 = new BinaryTree(node4);
            Node node2 = new Node(2);
            ...
            List<object> overlapping = TreeIntersections(bt1, bt2);
            List<object> expectedValues = new List<object>() { 4, 2, 5 };
            Assert.Equal(overlapping, expectedValues);
        }
    }
}
